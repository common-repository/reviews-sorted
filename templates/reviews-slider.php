...
?>
<div class="<?php esc_attr_e($wraperClass) ?>" style="<?php echo sprintf('--gap: %spx', $options['space']); ?>">

    <div class="swiper reviews-sorted slide-layout reviews-slider" data-options='<?php echo json_encode($slideOptions) ?>'>
